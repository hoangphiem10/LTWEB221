    ...
    <div class="card-body">
        ...
        if (isset($_POST['submit'])) {
            ...
            if (!isset($data["id"])) {
                if (($data["categoryModal"]->con)->query("INSERT INTO category (category_id,category_name) VALUES (N'$id', N'$name')")) {
                    echo "<script type='text/javascript'>
                            window.location.href = 'http://localhost:8081/LTWEB221/Category/index';
                            </script>";
                } else {
                    echo "<script type='text/javascript'>
                            window.location.href = 'http://localhost:8081/LTWEB221/Category/index';
        ...
        <form method="POST" action="">
            ...
            <div class="d-flex justify-content-end">
                <input type="submit" value="Save changes" class="btn btn-primary mx-4" name="submit">
                <a class="btn btn-success" href="http://localhost:8081/LTWEB221/Category/index">Back</a>
            </div>
