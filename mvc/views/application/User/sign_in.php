...
if (isset($_SESSION["email"]) && $_SESSION["role"] == "admin") {
    echo '<script type = "text/javascript">
            window.location.href = "http://localhost/LTWEB221/category/index"</script>';
}
...
if (isset($_POST['submit'])) {
    ...
    if (is_array($row)) {
        ...
        if (isset($_SESSION["email"])) {
            ...
            //     echo '<script type = "text/javascript">
            //     window.location.href = "http://localhost/LTWEB221/Home/payment/"</script>';
            // }
            else {
                echo '<script type = "text/javascript">
                window.location.href = "http://localhost/LTWEB221/"</script>';
        ...
        echo '<script type = "text/javascript">
            ...
            window.location.href = "http://localhost/LTWEB221/User/sign_in"</script>';
    }
}
?>
<style>
...
<div class="login-form">
    <form method="post" name="login" class="form-style">
        ...
        <div class="forgot">
            <a href="http://localhost/LTWEB221/user/sign_up" class="forgotPass" style="float: left;">
                Đăng ký
            </a>
