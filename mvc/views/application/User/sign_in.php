...
if (isset($_SESSION["email"]) && $_SESSION["role"] == "admin") {
    echo '<script type = "text/javascript">
            window.location.href = "http://localhost:8081/LTWEB221/category/index"</script>';
}
...
if (isset($_POST['submit'])) {
    ...
    if (is_array($row)) {
        ...
        if (isset($_SESSION["email"])) {
            ...
            //     echo '<script type = "text/javascript">
            //     window.location.href = "http://localhost:8081/LTWEB221/Home/payment/"</script>';
            // }
            else {
                echo '<script type = "text/javascript">
                window.location.href = "http://localhost:8081/LTWEB221/"</script>';
        ...
        echo '<script type = "text/javascript">
            ...
            window.location.href = "http://localhost:8081/LTWEB221/User/sign_in"</script>';
    }
}
?>
<style>
    body {
        height: 100vh;
        width: 100vw;
        background: center / cover no-repeat url("../../../LTWEB221/public/assets/img/background.png");
        overflow: hidden;
        display: flex;
    ...
    <form method="post" name="login" class="form-style">
        <div class="form-logo">
            <a href="http://localhost:8081/LTWEB221/home/index">
                <img src="../../../LTWEB221/public/assets/img/Bach-Hoa-Xanh-Logo.png" alt="logo">
            </a>
        ...
        <div class="forgot">
            <a href="http://localhost:8081/LTWEB221/user/sign_up" class="forgotPass" style="float: left;">
                Đăng ký
            </a>
