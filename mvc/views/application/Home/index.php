      ...
      <div class="uk-container"> 
        <ul class="js-filter uk-grid uk-grid-small uk-child-width-1-2@s uk-child-width-1-4@l" data-uk-grid>    
            ...
            <li class="category-card" style="text-align :center;">
              <a href="http://localhost/LTWEB221/home/catalog">
...
<div class="uk-margin-medium-top"><a class="uk-button" href="http://localhost/LTWEB221/home/catalog"><span>Mua ngay</span></a></div>
                </div>
    ...
    <div class="category" style="padding-bottom:30px;">
      ...
      <div class="uk-container">   
        <div class="js-filter uk-grid uk-grid-small uk-child-width-1-2@s uk-child-width-1-4@l" data-uk-grid >
          <li class="category-card" style="text-align: center;">
            <a href="http://localhost/LTWEB221/home/product/11"style="text-decoration: none;">
              <div class="category-img">
          ...
          <li class="category-card" style="text-align: center;">
            <a href="http://localhost/LTWEB221/home/product/13"style="text-decoration: none;">
              <div class="category-img">
          ...
          <li class="category-card" style="text-align: center;">
            <a href="http://localhost/LTWEB221/home/product/31"style="text-decoration: none;">
              <div class="category-img">
          ...
          <li class="category-card" style="text-align: center;">
            <a href="http://localhost/LTWEB221/home/product/12"style="text-decoration: none;">
              <div class="category-img">
