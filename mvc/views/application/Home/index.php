      ...
      <div class="uk-container"> 
        <ul class="js-filter uk-grid uk-grid-small uk-child-width-1-2@s uk-child-width-1-4@l" data-uk-grid>    
            ...
            <li class="category-card" style="text-align :center;">
              <a href="http://localhost:8081/LTWEB221/home/catalog">
              <div class="category-img">
                <img src="../../../LTWEB221/public/assets/img/pages/home/fruit.png" alt="">
              </div>
            ...
            <li class="category-card" style="text-align :center;">
              <a href="http://localhost:8081/LTWEB221/home/catalog">
                <div class="category-img">
                  <img src="../../../LTWEB221/public/assets/img/pages/home/meat.png" alt="">
                </div>
            ...
            <li class="category-card" style="text-align :center;">
              <a href="http://localhost:8081/LTWEB221/home/catalog">
                <div class="category-img">
                  <img src="../../../LTWEB221/public/assets/img/pages/home/vegetable.jpg" alt="">
                </div>
                <h5 class="name">Các loại thịt</h5>
              </a>
            </li>
            <li class="category-card" style="text-align :center;">
              <a href="http://localhost:8081/LTWEB221/home/catalog">
                <div class="category-img">
                  <img src="../../../LTWEB221/public/assets/img/pages/home/sea.jpg" alt="">
                </div>
                <h5 class="name">Các loại thịt</h5>
              </a>
            </li>
...
<div class="uk-margin-medium-top"><a class="uk-button" href="http://localhost:8081/LTWEB221/home/catalog"><span>Mua ngay</span></a></div>
                </div>
...
<!--=======================TRAI CAY KHUYEN MAI=====================-->
    <div class="category" style="padding-bottom:30px;">
      ...
      <div class="uk-container">   
        <div class="js-filter uk-grid uk-grid-small uk-child-width-1-2@s uk-child-width-1-4@l" data-uk-grid >
          <li class="category-card" style="text-align: center;">
            <a href="http://localhost:8081/LTWEB221/home/product/11"style="text-decoration: none;">
              <div class="category-img">
                <img src="../../../LTWEB221/public/assets/img/products/11.png" alt="">
              </div>
              <h5 class="name">Dưa lưới vỏ xanh</h5>
            </a>
          </li>
          <li class="category-card" style="text-align: center;">
            <a href="http://localhost:8081/LTWEB221/home/product/13"style="text-decoration: none;">
              <div class="category-img">
                <img src="../../../LTWEB221/public/assets/img/products/13.png" alt="">
              </div>
              <h5 class="name">Nho xanh không hạt</h5>
            </a>
          </li>
          <li class="category-card" style="text-align: center;">
            <a href="http://localhost:8081/LTWEB221/home/product/31"style="text-decoration: none;">
              <div class="category-img">
                <img src="../../../LTWEB221/public/assets/img/products/31.png" alt="">
              </div>
              <h5 class="name">Bí xanh</h5>
            </a>
          </li>
          <li class="category-card" style="text-align: center;">
            <a href="http://localhost:8081/LTWEB221/home/product/12"style="text-decoration: none;">
              <div class="category-img">
                <img src="../../../LTWEB221/public/assets/img/products/12.png" alt="">
              </div>
    ...
    <div class="section-features"> 
      ...
      <div class="uk-grid uk-child-width-1-3@s" data-uk-grid style="text-align: center; padding-top:30px;padding-bottom:50px">
        <div>
          <img src="../../../LTWEB221/public/assets/img/pages/home/customer2.png" alt="">
      ...
      <div>
          <img src="../../../LTWEB221/public/assets/img/pages/home/customer1.png" alt="">
                            <p style="color: #56B280">
                              <i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i>
                            </p>
                        ...
                        <div>
                        <div>
                            <img src="../../../LTWEB221/public/assets/img/pages/home/customer3.png" alt="">
                            <p style="color: #56B280">
                              <i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i>
                            </p>
