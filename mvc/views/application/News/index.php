                                            ...
                                            <ul class="list-articles">
                                                ...
                                                ?>
                                                    <li class="list-articles-item">
                                                        ...
                                                        <a class="list-articles-item__link" href="http://localhost:8081/LTWEB221/news/detail/<?php echo $row["news_id"] ?>">
                                ...
                                <article class="article-intro">
                                    ...
                                    <div class="article-intro__body">
                                        ...
                                        <div class="article-intro__bottom">
                                            ...
                                            <div class="article-intro__more"><a class="uk-button" href="http://localhost:8081/LTWEB221/news/detail/<?php echo $e["news_id"] ?>">Chi
                                                    Tiết</a></div>
                                        </div>
                                    </div>
                                </article>
